...
notifyButton.addEventListener('click', () => {
    if (!inProgress) {
        ...
        const auxquery = fixedEncodeURIComponent(notifyButton.getAttribute('data-auxquery'))
        let url = notifyButton.getAttribute('data-url') + '?query=' + query + '&source=' + source + '&auxquery=' + auxquery
